	...
	public boolean SwitchWindowByTitle(WebDriver driver, String windowTitle) {
		...
		try {
			...
			for (int i = 0; i < windowhandles.size(); i++) {
				...
				if (title1.contains(windowTitle)) {
					Thread.sleep(1500);
			...
			if (flag) {
				System.out.println("Navigated to the window with title: " + title1);
			} else {
				System.out.println("The Window with title:[ "+title1+ "] is not Selected");
			}
		}
	}
